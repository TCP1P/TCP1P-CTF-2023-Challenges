...
app.config['SECRET_KEY'] = 'dnacjkanjkcnandncnsnckandcacnadkncacnacknsack'
# database name
...
def token_required(f):
	...
	def decorated(*args, **kwargs):
		...
		if "admin" in data and data["admin"]:
			flash('Welcome, Admin. Here\'s your flag: TCP1P{im_only_human_after_all_dont_put_your_blame_on_me}')
